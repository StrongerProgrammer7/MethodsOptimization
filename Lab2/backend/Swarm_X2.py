...
class Swarm:
    def __init__(self, sizeSwarm,
        ...
        self.function = function
        # область поиска
        #TODO: в качестве старта может прийти как словарь(ниже) так и обычные числа например START = -2 END = 2
        #TODO:Если пришел словарь START[1] = начало х START[2] = конец х аналогично END для у
        #TODO: Переписать алгоритм если задан отличный диапазон
        self.start = start
        self.end = end
        # рой частиц
        self.swarm = []
